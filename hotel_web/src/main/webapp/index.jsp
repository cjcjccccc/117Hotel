    ...
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            ...
            <c:if test="${pageContext.request.userPrincipal.name != null}">
                ...
                <li data-id="register" class="layui-nav-item layui-hide-xs ">
                    <a class="fly-case-active" data-type="toTopNav" href="/logout">退出</a>
                </li>
            </c:if>
        ...
        <form class="layui-form layuimini-form">
            <div class="input-search">
                ...
                <div class="layui-container layui-hide-xs"><a href="#" class="topbar-logo"> <img
                        src="${pageContext.request.contextPath}/static/images/logo-1.png" alt="layui"> </a>
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="layui-carousel" lay-filter="LAY-store-banner" id="LAY-store-banner" lay-anim lay-indicator="inside" >
            <div carousel-item>
                <div class="">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/2.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
                <div class="">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/3.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
                <div class="layui-this">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/4.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
                <div class="">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/5.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
                <div class="">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/1.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
                <div class="">
                    <div class="layui-container">
                        <a href="javascript:;" target="_blank">
                            <img src="${pageContext.request.contextPath}/static/images/6.jpg" alt="酒店系统">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="layui-container">
                    ...
                    <div class="layui-row layui-col-space20">
                        <c:forEach var="room" items="${roomList}">
                            ...
                            <a class="template store-list-box fly-case-active" href="/room/toDetail/${room.id}.html" data-type="toRoomInfo">
                                <img src="http://localhost:8090/hotel/show/room-pic/main/${room.photo}" class="store-list-cover">
